...
do_combine = function(A,B,matching_columns,keep_cols,tag_ids,source_col,exclude_cols=NULL) {
    ...
    # exclude named columns if requested
    if (length(exclude_cols)>0) {
        w=which(colnames(g) %in% exclude_cols)
        if (length(w)>0) {
            g=g[,-w]
        }
    }
...
setMethod(f = "combine_annotations",
    ...
    definition = function(A,B,matching_columns=NULL,keep_cols=NULL,
                          tag_ids=FALSE,source_col='annotation_table',
                          exclude_cols=NULL) {
        ...
        g = do_combine(A,B,all_matching,keep_cols,tag_ids,
        ...
        OUT = annotation_table(
            ...
            description = paste0('This annotation_table object was generated ',
...
setMethod(f = "combine_annotations",
    ...
    definition = function(A,B,matching_columns=NULL,keep_cols=NULL,
        ...
        OUT = lcms_table(
                ...
                tag = 'combined',
                name = 'Combined annotation source',
                description = c('This annotation_table object was generated by ',
                    'combining two other sources.'),
                id_column = 'id',
                mz_column = 'mz',
                rt_column = 'rt'
            )
