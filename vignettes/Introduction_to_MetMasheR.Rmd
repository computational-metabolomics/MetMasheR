...
A number of annotation_table  objects have been implemented to import and parse various types of data tables.  The objects are extended versions of the basic metabolite annotation source object `annotion_table`:
